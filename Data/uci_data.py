# UCI Adult dataset, Data loading and preprocessing for 3 binary classification tasks: 1) age >= 40, 2) education level >= Bachelors, 3) marital status = Never married. 
